...
function Homeworkadmin() {
    ...
    const fetchhomework = async () => {
        ...
        try{
            await axios.get('node-api-production-a142.up.railway.app/homework')
            .then(res => {
                setitems(res.data);
                console.log(res)
            })
    ...
    async function submit(e) {
      ...
      if(subject === "") {
        ...
        try{
          await axios.post('node-api-production-a142.up.railway.app/homework', {subject, desc})
          setpopup(false)
          fetchhomework()
      }
    ...
    async function deletetag(id) {
      try{
        ...
        await axios.delete('node-api-production-a142.up.railway.app/homework/' + id)
      }
