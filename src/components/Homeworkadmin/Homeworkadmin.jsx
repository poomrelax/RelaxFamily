...
function Homeworkadmin() {
    ...
    const fetchhomework = async () => {
        ...
        try{
            await axios.get('https://node-api-production-a142.up.railway.app/homework')
            .then(res => {
                setitems(res.data);
                console.log(res)
            })
    ...
    async function submit(e) {
      ...
      if(subject === "") {
        ...
        try{
          await axios.post('https://node-api-production-a142.up.railway.app/homework', {subject, desc})
          setpopup(false)
          fetchhomework()
      }
    ...
    async function deletetag(id) {
      try{
        ...
        await axios.delete('https://node-api-production-a142.up.railway.app/homework/' + id)
      }
